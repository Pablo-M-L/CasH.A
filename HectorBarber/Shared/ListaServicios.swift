...
struct celdaServicios: View{
    ...
    var body: some View{
        ...
        .onAppear{
                ...
                descripcionServicio = servicio.descripcionServicio ?? "sin descripcion"
...
struct anyadirServicio: View{
    ...
    @State private var descripcionServicio = "Descripcion"
            ...
            VStack(alignment: .center){
                ...
                Form{
                    Section(header: Text("Category")) {
                        Text("Categoria: \(categoriaSeleccionada)")
                            .onTapGesture {
                                mostrarCategorias.toggle()
                            }
                    }
                    Section(header: Text("Titulo")){
                        TextField("Titulo del servicio", text: $nombreServicio)
                    }
